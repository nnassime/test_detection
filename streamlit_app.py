...
def load_model():
    ...
    if not os.path.exists(wpath):
        ...
        os.system("python -m pip install numpy torch pandas Pillow opencv-python>=4.5.3.56 opencv-python-headless PyYAML>=5.3.1 torchvision>=0.8.1 matplotlib seaborn>=0.11.0 easydict")
