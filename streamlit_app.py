...
def load_model():
    ...
    if not os.path.exists(wpath):
        ...
        os.system("python -m pip install numpy torch pandas Pillow opencv-python-headless PyYAML>=5.3.1 opencv-contrib-python torchvision>=0.8.1 matplotlib seaborn>=0.11.0 easydict")
